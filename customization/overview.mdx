---
title: "How to Customize the Decision Rain Library Template"
sidebarTitle: "Customization"
description: "Adapt fit tags, domains, item types, priority markers, and examples to your environment. Governance rules protect the taxonomy from unauthorized changes."
---
...
<CardGroup cols={2}>
  <Card title="Fit Tags" icon="wrench" href="/customization/fit-tags">
  ...
  <Card title="Domains" icon="folder-open" href="/reference/tag-registry">
  ...
  <Card title="Item Types" icon="tag" href="/reference/tag-registry">
  ...
  <Card title="Priority Markers" icon="flag" href="/reference/tag-registry">
  ...
  <Card title="Golden Examples" icon="star" href="/reference/examples">
