---
title: "What Counts as a Signal Worth Capturing"
...
Once a signal is processed, it receives a `type/*` tag that describes what kind of object the link actually is — independent of where it came from or how useful it turns out to be.

| Tag | Describes |
|---|---|
| `type/repo` | A hosted code repository |
| `type/guide` | A walkthrough or how-to |
| `type/paper` | Academic or research writing |
| `type/service` | A product, SaaS, or API |
| `type/directory` | A curated list or aggregation |
| `type/pattern` | A design or architectural pattern |
| `type/tutorial` | A step-by-step instructional resource |
| `type/idea` | A concept or workflow spark |
| `type/framework` | A structured methodology or runtime |
| `type/docs` | Official documentation or reference |
